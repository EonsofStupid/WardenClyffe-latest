<?php
$page_title = '⚖️ Load Balancer — WardenClyffe Docs';
...
<div class="wiki-layout">
    ...
    <main class="wiki-content">
            ...
            <div class="content-section">
                <h2>Overview</h2>
                <p>WardenClyffeScale includes a built-in load balancer that distributes database queries across healthy nodes. It supports read/write splitting, health checking, and multiple routing algorithms.</p>
                <h3>Features</h3>
                <ul>
                ...
                <h3>Usage</h3>
                <p>Connect your application to WardenClyffeScale&rsquo;s load balancer port (default: 3307) instead of directly to MySQL. WardenClyffeScale handles the routing.</p>
            </div>
