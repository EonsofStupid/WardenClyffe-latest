<?php
$page_title = '🔧 WardenClyffeScale Configuration — WardenClyffe Docs';
$page_desc = 'Complete configuration reference for WardenClyffeScale';
...
<div class="wiki-layout">
    ...
    <main class="wiki-content">
            ...
            <div class="content-section">
                ...
                <p>WardenClyffeScale is configured via <code>/etc/wardenclyffescale/config.toml</code>.</p>
