<?php
$page_title = '⚙️ How WardenClyffeScale Works — WardenClyffe Docs';
$page_desc = 'Understanding WardenClyffeScale\'s replication mechanism';
    ...
    <main class="wiki-content">
            ...
            <div class="content-section">
                ...
                <ol>
                    ...
                    <li>WardenClyffeScale captures the change via the binary log</li>
                ...
                <p>WardenClyffeScale provides <strong>eventual consistency</strong> with configurable conflict resolution. For most workloads, replication lag is under 100ms.</p>
            </div>
