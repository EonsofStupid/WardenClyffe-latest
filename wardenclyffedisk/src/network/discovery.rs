//! UDP Broadcast Discovery for WardenClyffeDisk nodes
//!
//! Uses broadcast (255.255.255.255) for node discovery, same as WardenClyffeScale.
...
const DISCOVERY_PREFIX: &str = "WARDENCLYFFEDISK";
...
fn run_broadcaster(
    ...
    // Broadcast destinations: 255.255.255.255 for LAN, plus subnet broadcast for WardenClyffeNet
    ...
    // cross-subnet and WardenClyffeNet connectivity where broadcast doesn't work
