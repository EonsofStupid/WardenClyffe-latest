//! Cluster state management and leader election for WardenClyffeDisk
...
impl ClusterManager {
    ...
    /// Write cluster status to file for wardenclyffediskctl
    pub fn write_status_file(&self) {
        self.write_status_file_with_stats(0, 0);
    }

    /// Write cluster status with file index stats for wardenclyffediskctl
