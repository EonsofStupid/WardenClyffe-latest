...
export async function up(knex: Knex): Promise<void> {
  ...
  // (dangtony98): backfill by adding null defaults CAs for all existing Vaultix SSH projects
  // that do not have an associated ProjectSshConfig record introduced in Vaultix SSH V2.
