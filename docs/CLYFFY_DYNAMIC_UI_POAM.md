...
Verified on 2026-05-22 and updated through 2026-05-27:
...
| Warden agent workspace UI | Go Warden `/agent-workspaces` lists VS Code, Cursor, Codex, Claude, devstation, capsule, and shared-storage launch points |
